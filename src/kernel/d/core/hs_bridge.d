...
void d_display_heartbeat() @nogc nothrow {
    ...
    immutable uint width = cast(uint)(g_fb.width < 64 ? g_fb.width : 64u);
    immutable uint height = cast(uint)(g_fb.height < 8 ? g_fb.height : 8u);
    immutable uint pitchPixels = cast(uint)(g_fb.pitch / 4);
